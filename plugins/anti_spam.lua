  ...
  if msg.from.type == 'user' then
    ...
    if msgs > max_msg then
	  ...
	  if msg.to.type == 'chat' or msg.to.type == 'channel' then
		if username then
			savelog(msg.to.id, name_log.." @"..username.." ["..msg.from.id.."] الـمـطـ{👞}ـروديـن بـسـ(‼️)ـبـب تـفـلـ{🙀}ـيـش")
			send_large_msg(receiver , "تـ{✅}ـم كـتـ(‼️)ـشـافـ» تـفـلـ{🙀}ـيـش\nاسـم الـمـشـ(☠)ـتـبـه "..msg.from.first_name.."\nتـ{✅}ـم طـ(👞)ـرده\n#user : @"..(msg.from.username or "error").."\n")
		else
      ...
      if gbanspamonredis then
        if tonumber(gbanspamonredis) ==  4 and not is_owner(msg) then
          ...
          send_large_msg("chat#id"..msg.to.id, "تـ{✅}ـم كـتـ(‼️)ـشـافـ» تـفـلـ{🙀}ـيـش\nاسـم الـمـشـ(☠)ـتـبـه "..msg.from.first_name.."\nتـ{✅}ـم طـ(👞)ـرده\n#user : @"..(msg.from.username or "error").."\n")
		  ...
		  for k,v in pairs(GBan_log) do
			log_SuperGroup = v
			gban_text = "تـ{✅}ـم كـتـ(‼️)ـشـافـ» تـفـلـ{🙀}ـيـش\nاسـم الـمـشـ(☠)ـتـبـه "..msg.from.first_name.."\nتـ{✅}ـم طـ(👞)ـرده\n#user : @"..(msg.from.username or "error").."\n"
